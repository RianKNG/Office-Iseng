...
<div class="container-fluid py-4">
    ...
    <div class="row g-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                @php
                                    ...
                                    ][$disposisi->prioritas] ?? ['bg' => 'secondary', 'icon' => 'circle'];
                                @endphp
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                @if($disposisi->deadline)
                                    @php $isOverdue = $disposisi->deadline < now() && $disposisi->status != 'selesai'; @endphp
        ...
        <div class="col-lg-4">
            {{-- Aksi Proses (Hanya muncul jika status belum diproses) --}}
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('disposisi.process', $disposisi->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="instruksi" class="form-control" rows="3" placeholder="Tuliskan tindakan yang dilakukan..."></textarea>
                        </div>
                        
                        <div class="d-grid gap-2">
                            <button type="submit" name="action" value="approve" class="btn btn-success">
                                <i class="bi bi-check-lg"></i> Tandai Selesai / Teruskan
                            </button>
            ...
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <select name="ke_user_id" class="form-select select2" required>
...
@push('scripts')
<script>
    // Inisialisasi Tooltip atau Select2 jika diperlukan
